 ...
 *
 * Migrated from the legacy `src/lib/leave-format.ts` (formatLeaveDetail)
 * and `src/lib/leave-date-parser.ts` (formatItDate). The originals are
 * retained as re-export shims for back-compat.
 */
